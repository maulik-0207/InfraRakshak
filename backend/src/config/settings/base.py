"""
Django settings for InfraRakshak project.

Generated by 'django-str startproject' using django-structurator-1.3.0 tool.

For more information on this file, see
https://docs.djangoproject.com/en/6.0.4/topics/settings/

For the full list of settings and their values, see
https://docs.djangoproject.com/en/6.0.4/ref/settings/
"""
...
# Database
# https://docs.djangoproject.com/en/6.0.4/ref/settings/#databases
...
# Password validation
# https://docs.djangoproject.com/en/6.0.4/ref/settings/#auth-password-validators
...
# https://docs.djangoproject.com/en/6.0.4/howto/static-files/
...
LOGS_DIR = os.path.join(BASE_DIR.parent.parent, 'logs')
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Infrarakshak Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Infrarakshak",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Infrarakshak",
    ...
    "welcome_sign": "Welcome to the Infrarakshak Admin",

    # Copyright on the footer
    "copyright": "Infrarakshak Pvt Ltd",
