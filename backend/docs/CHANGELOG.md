...
All notable changes to the `InfraRakshak` project will be documented in this file. This project adheres to [Semantic Versioning](https://semver.org/).
...
### Added
- Initial release of `InfraRakshak`.
...
- Added strict `AI_CONTEXT.md` and `ARCHITECTURE.md` documentation to assist AI Agents with boundary logic.
